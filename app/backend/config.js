...
const PROMPTS_DB_NAME  = 'jc-config-prompts';
...
const REVOCATION_FILE  = path.join(BACKUP_DIR, 'session-revocation.json');
...
module.exports = {
  ...
  BACKUP_DIR, BACKUP_INTERVAL_MS, REVOCATION_FILE, ATTACHMENTS_DIR, JSON_BACKUP_DIR, COUCHDB_DATA_DIR,
